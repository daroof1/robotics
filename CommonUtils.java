...
public class CommonUtils extends LinearOpMode {
    ...
    public void craterAuto() throws InterruptedException {

    }
    public void depotAuto() throws InterruptedException {
    ...
    public void Auto() throws InterruptedException {
        ...
        if(x.equals("Left"))
        {
            ...
            knockLeft();
            if (craterSide) {
                driveAfterSampleCrater();
            } else {
                driveAfterSampleDepot();
            }
        }
        if(x.equals("Center"))
        {
    ...
    public void driveBeforeSample()
    {
        encoderDrive(1,4,4,100);
    }
    public void driveAfterSampleCrater()
    {
        encoderDrive(1,21.5,21.5,100);
        encoderDrive(1,-5.25,5.25,100);
    ...
    public void driveAfterSampleDepot()
    {
        encoderDrive(1,21.5,21.5,100);
        encoderDrive(1,-5.25,5.25,100);
    ...
    public void beforePlay() throws InterruptedException {
