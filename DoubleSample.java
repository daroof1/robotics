...
@Autonomous(name = "CraterDoubleSample",group = "LinearOpMode")
public class DoubleSample extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        {
            encoderDrive(1,-3.35,3.35,100);
            sleep(200);
            encoderDrive(1,14,14,100);
            sleep(200);
            encoderDrive(1,-4,-4,100);
            sleep(200);
            encoderDrive(1,-8.1,8.1,100);
            sleep(200);
            encoderDrive(1,14.7,14.7,100);
            sleep(200);
            encoderDrive(1,-4.3,4.3,100);
            sleep(200);
            encoderDrive(1,21.5,21.5,100);
            //sleep(200);
            dropTheMarker();
            //sleep(200);
            encoderDrive(1,9.3,-9.3,100);
            sleep(200);
        ...
        else if(x.equals("Center"))
        {
            ...
            dropTheMarker();
            //sleep(200);
            encoderDrive(1,6.7,-6.7,100);
            sleep(200);
            encoderDrive(1,-11.5,-11.5,100);
        }
    ...
    {
        robot.VexMotor.setPower(-1);
        sleep(3500);
        robot.VexMotor.setPower(0);
    }*/
    public String ImageSensing(String sides) {
